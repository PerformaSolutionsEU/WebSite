...
This document describes the processing of personal data carried out through the website **www.performasolutions.eu** (hereinafter, "the Site") pursuant to Regulation (EU) 2016/679 (GDPR).

## Data controller

The data controller is the company publishing **www.performasolutions.eu**.

- **Contact email**: **info@performasolutions.eu**

Full identifying details of the controller (legal name, registered address, VAT/Tax ID and certified email) are provided on request at the email address above and will be published once the administrative procedures of company incorporation are complete.

{/* TODO: once corporate details are finalized, replace the paragraph above with the structured block: Legal entity, Registered address, VAT/Tax ID, PEC. */}

## Data Protection Officer (DPO)

The Controller has not designated a DPO as the conditions for mandatory designation under Article 37 GDPR do not apply (no large-scale processing, no systematic processing of special categories of data).
