...
description: "Cost-to-serve by service, by channel, by season in hospitality operations with multiple business lines. Performa's template already configured for rooms, F&B, wellness."
